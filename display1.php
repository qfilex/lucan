...
$mint = "SELECT id, mint FROM mint";
$mina="SELECT id, mnat FROM minvb";
$result = $conn->query($sql);
$minutei=$conn->query($mint);
$minuten=$conn->query($mint);
...
<thead>
     ...
     while($row = $result->fetch_assoc() or $row1 = $minutei->fetch_assoc() or $row2 = $minuten->fetch_assoc()) {
